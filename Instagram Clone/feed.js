
            posts: [
        ...
        },
        {
            ...
            story:"https://media.igram.world/get?__sig=TW1YaRaFv5vVjHbJ49vgiQ&__expires=1714065603&uri=https%3A%2F%2Finstagram.fsub2-2.fna.fbcdn.net%2Fv%2Ft51.29350-15%2F440362259_805312821505466_6430552650171326426_n.jpg%3Fstp%3Ddst-jpg_e35_p1080x1080%26_nc_ht%3Dinstagram.fsub2-2.fna.fbcdn.net%26_nc_cat%3D102%26_nc_ohc%3DeWOyl-umHJIQ7kNvgGudjpZ%26edm%3DAOQ1c0wBAAAA%26ccb%3D7-5%26oh%3D00_AfDlqpRjIT_aYdSRkjLQwoVOhlJwOQDrRp0dju3MpUfMFA%26oe%3D66301B48%26_nc_sid%3D8b3546",
            posts: [
        ...
        },
        {
            ...
            story:"https://media.igram.world/get?__sig=5eBkKIiOth_N2la8RqDYxg&__expires=1714065651&uri=https%3A%2F%2Finstagram.fyyc2-1.fna.fbcdn.net%2Fv%2Ft51.29350-15%2F436317370_1777685389379948_3324965090961089877_n.jpg%3Fstp%3Ddst-jpg_e35_p1080x1080%26_nc_ht%3Dinstagram.fyyc2-1.fna.fbcdn.net%26_nc_cat%3D108%26_nc_ohc%3D7HSht8bX1QEQ7kNvgGot4HA%26edm%3DAOQ1c0wBAAAA%26ccb%3D7-5%26oh%3D00_AfCwaugeLtDjfIc8Xk-B9s2u46_5ZHA4d8C1m9saZBffkQ%26oe%3D66306F27%26_nc_sid%3D8b3546",
            posts: [
        ...
        },
        {
            ...
            story:"https://media.igram.world/get?__sig=_jKIvHJkhAYaVt7CrySUeg&__expires=1714065696&uri=https%3A%2F%2Fscontent-cdg4-2.cdninstagram.com%2Fv%2Ft51.29350-15%2F437303239_753035679968107_1324124594024576573_n.jpg%3Fstp%3Ddst-jpg_e35_p1080x1080%26_nc_ht%3Dscontent-cdg4-2.cdninstagram.com%26_nc_cat%3D107%26_nc_ohc%3Dg1riq5X0dfgQ7kNvgFYJm27%26edm%3DAOQ1c0wBAAAA%26ccb%3D7-5%26oh%3D00_AfC-4YqGi4DEY_PkeJCjyp48gK6U1fUoPClFVsKekX11Dw%26oe%3D66305FA6%26_nc_sid%3D8b3546",
            posts: [
    ...
    profiledata.forEach(function(elem,idx){
        ...
        `<div id="stori">
        <div id="storiyborder">
            <img src="${elem.dp}" alt="${elem.user}">
            <h6>${elem.user}</h6>
        </div>
</div>`;
document.querySelector(".story-bar").innerHTML = clutter
    });
...
profiledata.forEach(user => {
    if (Array.isArray(user.posts) && user.posts.length > 0) {
        const randomIndex = Math.floor(Math.random() * user.posts.length); // Generate a random index
        const randomPost = user.posts[randomIndex]; 
        const randomPostUrl = randomPost.url; 
        clutterfeedpost += `
            <div id="main-feed-post">
                <div id="feed-post-outerbox">
                    <div id="feed-post-upper-features">
                        <div id="dp-usernmaekk">
                            <img src="${user.dp}" alt="">
                            <h5>${user.user}</h5>
                        </div>
                        <button id = "post-threedots" ><i class="fa-solid fa-ellipsis"></i></button>
                    </div>
                    <div id="feed-post-img">
                        <img src="${randomPostUrl}" alt="">
                    </div>
                    <div id="feed-post-lower-btns">
                        <div id="like-comt-share-btns-outer">
                            <button id="heart-like"><i id="heart-like-unlike" class="fa-regular fa-heart"></i> <i id="heart-like-like" class="fa-solid fa-heart"></i></button>
                            <button><i class="fa-regular fa-comment"></i></button>
                            <button><i class="fa-solid fa-location-arrow"></i></button>
                        </div>
                        <div id="bookmark-btnonfeed">
                            <button><i id="feed-post-save" class="fa-regular fa-bookmark"></i><i id="feed-post-savefill"  class="fa-solid fa-bookmark"></i></button>
                        </div>
                    </div>
                    <div id="likes_counter">
                        <div id="likes_countervalu">${randomPost.likes}</div>
                        <h4>likes</h4>
                    </div>
                    <div id="feed-capction-section">
                        <p><a id="feed-capction-user">${user.user}</a>${randomPost.caption}</p>
                        <a id="feed-capction-hash">${randomPost.hashtags}</a>
                    </div>
...
document.querySelector(".main-feed-post-column").innerHTML = clutterfeedpost;
var likes_feed = document.querySelectorAll("#likes_countervalu");
let flageforheartfeed = 1;
const heart_like = document.getElementById("heart-like")
heart_like.addEventListener('click',function(){
    if (flageforheartfeed == 1) {
        document.getElementById('heart-like-unlike').style.display = 'none';
        document.getElementById('heart-like-like').style.display = 'block';
        flageforheartfeed = 0;  
         var currentLikes = parseInt(likes_feed.innerHTML);
         likes_feed.innerHTML = currentLikes + 1;
    } else {
        document.getElementById('heart-like-unlike').style.display = 'block';
        document.getElementById('heart-like-like').style.display = 'none';
        var currentLikes = parseInt(likes_feed.innerHTML);
        likes_feed.innerHTML = currentLikes - 1;
        flageforheartfeed = 1;
    }
})
// let flageforsavefeed = 1;
// const feed_save_btn = document.getElementById("bookmark-btnonfeed")
// feed_save_btn.addEventListener('click',function(){
//     if (flageforsavefeed == 1) {
//         document.getElementById('feed-post-savefill').style.display = 'none';
//         document.getElementById('feed-post-save').style.display = 'block';
//         flageforsavefeed = 0;
//     } else {
//         document.getElementById('feed-post-savefill').style.display = 'block';
//         document.getElementById('feed-post-save').style.display = 'none';
//         flageforsavefeed = 1;
//     }
// })
const images = document.querySelectorAll('.story-bar img');
images.forEach(function(image) {
    image.addEventListener('click', function(dets) {
        var targetUser = dets.srcElement.alt; // Specify the username of the user you want to display
        document.querySelector('.storyscreen').style.display = 'block';
        document.querySelector('.storyscreen').style.display = 'flex';
        const heart_like = document.getElementById("heart-like")
        heart_like.addEventListener('click',function(){
            console.log("OM");
        })
        var clutterstory = "";
        // Filter profiledata to get the user with username "elvish_yadav"
        var userStories = profiledata.filter(function(elem) {
            return elem.user === targetUser;
        });
        // Iterate over the filtered user's stories
        userStories.forEach(function(elem, idx) {
            clutterstory += `<img src="${elem.story}" alt="img-${idx + 1}">`;
        });
        document.querySelector("#for_change_by_chrat").innerHTML = clutterstory;
var clutterusernameanddpstori = "";
profiledata.forEach(function(elem, idx) {
    if (elem.user === targetUser) {
        clutterusernameanddpstori += `  <img src="${elem.dp}" alt="img-${idx + 1}">
         <h5>${elem.user}</h5>`;
        document.querySelector("#storyuppercrdfunctions-left").innerHTML = clutterusernameanddpstori;
        // Exit the loop once the target user is found
        return;
    }
});
     });
...
let flageforvol = 1;
let volm_btnsori = document.getElementById('volm-btnsori');
volm_btnsori.addEventListener('click', function() {
    if (flageforvol == 1) {
...
let flageforpause = 1;
let play_btnsori = document.getElementById('play-btnsori')
play_btnsori.addEventListener('click',function(){
    if (flageforpause == 1) {
...
let flageforheart = 1;
let heart_btnforsto = document.getElementById('heart_btnforsto')
heart_btnforsto.addEventListener('click',function(){
    if (flageforheart == 1) {
        document.getElementById('heardfill').style.display = 'none';
        document.getElementById('heartunfill').style.display = 'block';
        flageforheart = 0;
    } else {
        document.getElementById('heardfill').style.display = 'block';
        document.getElementById('heartunfill').style.display = 'none';
        flageforheart = 1;
    }
})
let closebtn_stori = document.getElementById('closebtn-stori')
closebtn_stori.addEventListener('click',function(){
